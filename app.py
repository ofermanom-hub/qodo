...
def suggest_todo():
    # PLANTED ISSUE #2: fetch_weather_hint() can return None on upstream 5xx,
    # but we index into the result without checking.
...
def duplicate_titles():
    ...
    # PLANTED ISSUE #4: O(n^2) duplicate detection inside find_duplicate_titles.
    dupes = find_duplicate_titles(todos)
    # PLANTED ISSUE #5: print() instead of app_logger — violates .pr_agent.toml rule.
